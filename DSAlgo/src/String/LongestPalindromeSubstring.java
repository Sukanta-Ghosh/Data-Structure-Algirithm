...
Question link: https://www.geeksforgeeks.org/longest-palindromic-substring-set-2/
*/
public class LongestPalindromeSubstring {
    ...
    static int longestPalSubstr(String str) {
        ...
        // One by one consider every character as center point of even and odd length
        // palindromes
        for (int i = 1; i < len; ++i) {
